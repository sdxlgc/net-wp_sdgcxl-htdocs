...
class Qode_Theme_Options {
	...
	function qode_generate_options_page() {
		...
		<div id="qode-metaboxes-general" class="wrap">
		    ...
		    <h2 style="padding-top:25px;"><?php printf( __('version %1$s', 'qode'), '1.3.1' ); ?></h2>
				...
				<table class="form-table">
					<tbody>
						...
						<tr valign="top">
							...
							<td>
								<input name="qode_options_satellite[404_subtitle]" type="text" value="<?php if (isset($options['404_subtitle']) && $options['404_subtitle']) { echo esc_attr($options['404_subtitle'], 'qode'); } ?>"  />
							</td>
						</tr>
						<tr valign="top">
