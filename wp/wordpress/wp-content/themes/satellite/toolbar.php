    ...
    <div id="panel-admin">
		...
		<div class="panel-admin-box">
			...
			<div id="tootlbar_colors">
				<div class="color active color1" data-color="#0079ff" style="background-color:#0079ff;"></div>
				<div class="color color2" data-color="#aac2d3" style="background-color:#aac2d3;"></div>
				<div class="color color3" data-color="#93b711" style="background-color:#93b711;"></div>
				<div class="color color4" data-color="#16a085" style="background-color:#16a085;"></div>
				<div class="color color5" data-color="#f75100" style="background-color:#f75100;"></div>
				<div class="color color6" data-color="#f22a8d" style="background-color:#f22a8d;"></div>
			</div>
		</div>
